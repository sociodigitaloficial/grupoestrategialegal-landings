...
// ---------------------------------------- BASE DE DATOS
    ...
    if($conexion -> connect_errno){
        ...
        mysqli_query($conexion, "INSERT INTO contactos VALUES('$nombre','$correo','$whatsapp','$mensaje','$servicio','$fecha')");
    }
...
// >>> Cliente Interno
    ...
    $mail->addAddress('contacto.grupoestrategialegal@gmail.com');
	
	$mail->isHTML(true);
    $mail->Subject = 'Grupo Estrategia Legal has recibido un NUEVO CONTACTO';
	
$message = '<html><body>';
	$message .= "<p>Hola Grupo Estrategia Legal, gracias a la campaña de publicidad digital que actualmente tienes online has recibido un nuevo contacto interesado en tus servicios:</p>";
...
// >>> Cliente Externo
	...
	try {
		...
		$mail2->setFrom('notificaciones@grupoestrategialegal.cl', 'Grupo Estrategia Legal');
		$mail2->addAddress($correo);
		$mail2->addReplyTo('contacto.grupoestrategialegal@gmail.com');
		...
		$message .= "<p>Hola " . strip_tags($nombre) . ", gracias por confiar en nosotros y solicitar una asesoría con un abogado civil.</p>";
		...
		$message .= "<ul>";
		$message .= "<li>Llámanos o escríbenos un whatsapp al número +56991289568.</li>";
		$message .= "<li>Envíanos un correo directamente a contacto.grupoestrategialegal@gmail.com o respondiendo este mail.</li>";
		$message .= "</ul>";
